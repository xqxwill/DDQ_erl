...
from deep_dialog.agents import AgentPPO
...
def run_episodes(count, status):
    ...
    if agt == 11 and params['trained_model_path'] == None and warm_start == 1:
        print ('warm_start starting ...')
        warm_start_simulation()
        print ('warm_start finished, start RL training ...')

    for episode in xrange(count):
        print "xrange(count)::::{}".format(xrange(count))
        # sys.exit()
        ...
        while not episode_over:
            ...
            if episode_over:
                if reward > 0:
                    ...
                    print ("Failed Dialog!")
                cumulative_turns += dialog_manager.state_tracker.turn_count
        #         print "c_cunt:::{}".format(cumulative_turns)
        # print "cunt:::{}".format(cunt)

        # simulation
        if agt == 11 and params['trained_model_path'] == None:
            agent.predict_mode = True
            world_model.predict_mode = True
            # print "simulation_epoch_size:::{}".format(simulation_epoch_size)
            # print "grounded_for_model:::{}".format(grounded_for_model)
            ...
            # sys.exit()
            agent.train(batch_size, 1, episode)
...
# print "num_ep::{}".format(num_episodes)
